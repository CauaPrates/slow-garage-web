...
Antes de qualquer coisa, leia o que já existe: `AGENTS.md`, `README.md`, `docs/`, specs anteriores em `specs/`, e o código da área afetada. Metade das perguntas que você faria já está respondida no repo, e perguntar o que está escrito queima a paciência do humano.
